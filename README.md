...
$${\color{white}White}$$
##### Notes on Factories
- All **enums**, **arrays**, **structs** and other such items are made by $${\color{red}*factories*}$$. The **enum** <span style="color:orange">*factory*</span> is called by ***enum()***, **class** <span style="color:orange">*factory*</span> by ***class()***, etc.
