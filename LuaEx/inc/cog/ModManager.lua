...
return class("ModManager",
{--METAMETHODS

},
{--STATIC PUBLIC
    IMAGE_BASE_PATH = "Images",
    --ModManager = function(stapub) end,
    loadMods = function()
    ...
    getMod = function(sID)
        ...
        if (_tMods[sID] == nil) then
            error("Error getting mod path for mod, '${id}'. Mod does not exist" % {id = sID});
        end
...
{--PRIVATE
    ModManager = function(this, cdat) end,
},
{},--PROTECTED
{},--PUBLIC
nil,   --extending class
