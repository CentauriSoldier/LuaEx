...
{--metamethods
    __clone = function(this, cdat)
        ...
        local newcdat        = cdat.ins[oPotentiometer];
        local newpri         = newcdat.pri;

        newpri.alternator         = pri.alternator;
        newpri.isAtStart          = pri.isAtStart;
        newpri.isAtEnd            = pri.isAtEnd;
        newpri.toggleAlternator   = pri.toggleAlternator;
