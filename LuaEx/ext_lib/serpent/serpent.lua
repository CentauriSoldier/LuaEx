...
local badtype = {thread = true, userdata = false, cdata = true}
...
local function s(t, opts)
  ...
  local function val2str(t, name, indent, insref, path, plainindex, level)
    ...
    if type(mt) == 'table' and metatostring ~= false then
      ...
      --local so, sr = pcall(function() return mt.__serialize(t) end) TODO figure a way to get his up and running without conflicting with class
